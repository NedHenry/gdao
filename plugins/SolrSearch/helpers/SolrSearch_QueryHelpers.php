...
//        . "<div class='fc'>$count</div>";
   ...
   */
  public static function createQuery($query, $default='collection:"Grateful Dead Archive"')
  {
    ...
    return $q == 'collection:"Grateful Dead Archive"'
      ? $q : $q .= ' AND collection:"Grateful Dead Archive"';
  }
