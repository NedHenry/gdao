...
head(array('title' => $pageTitle, 'id' => 'items', 'bodyclass' => 'search-results'));
?>
...
<div id="primary">
	...
	<?php $number = 0; ?>
		...
		<div class="gdao_solr_result <?php echo ($number++ % 2) ? 'even' : 'odd';  ?> <?php
			echo (strcmp($curated, 'no') == 0) ? 'new-item' : ''; ?>">
		<?php $logo = $doc->__get('48_s'); ?>
		<?php $ark = $doc->__get('140_s'); ?>
		<?php $title = $doc->__get('50_s'); ?>
		<?php $itemtype = $doc->__get('itemtype'); ?>
		<?php $id = $doc->__get('id'); ?>
		<?php $restricted = $doc->__get('292_s'); ?>
		<?php set_current_item(get_item_by_id($id)); ?>
		...
		<?php elseif (item_has_files()): ?>
			...
			<?php $thumb_path = item_file('square thumbnail uri'); ?>
                	<div class="thumbnail_image">
                    		<?php $uri = html_escape(WEB_ROOT) . '/items/show/'; ?>
                    		<a href="<?php echo $uri . $id; ?>" alt="Item record">
		...
		<?php endif; ?>
			...
			<?php $uri = html_escape(WEB_ROOT) . '/solr-search/results/?solrq=39_s:'; ?>
			...
			<?php $uri = html_escape(WEB_ROOT) . '/solr-search/results/?solrq=38_s:'; ?>
